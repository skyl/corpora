...
pub trait CorpusApi: Send + Sync {
    fn create_corpus(
        ...
        url: Option<&str>,
    ) -> Pin<Box<dyn Future<Output = Result<models::CorpusResponseSchema, Error>> + Send>>;
    fn delete_corpus(
        &self,
        corpus_name: &str,
    ...
    fn list_corpora(
        &self,
    ) -> Pin<Box<dyn Future<Output = Result<Vec<models::CorpusResponseSchema>, Error>> + Send>>;
    fn update_files(
        &self,
        corpus_id: &str,
        tarball: std::path::PathBuf,
    ...
    C: Clone + std::marker::Send + Sync,
{
    ...
    fn get_corpus(
        ...
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/api/corpora/corpus/{corpus_id}".to_string(),
        );
    ...
    > {
        let mut req = __internal_request::Request::new(
            hyper::Method::GET,
            "/api/corpora/corpus/{corpus_id}/files".to_string(),
        );
        req = req.with_path_param("corpus_id".to_string(), corpus_id.to_string());
    ...
    {
        let mut req =
            __internal_request::Request::new(hyper::Method::GET, "/api/corpora/corpus".to_string());
