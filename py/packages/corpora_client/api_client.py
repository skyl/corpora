...
from corpora_client.api_response import ApiResponse, T as ApiResponseT
import corpora_client.models
from corpora_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(corpora_client.models, klass)
