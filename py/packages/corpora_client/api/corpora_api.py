...
class CorporaApi:
    ...
    def corpora_api_delete_corpus(
        ...
        _param = self._corpora_api_delete_corpus_serialize(
    ...
    @validate_call
    def corpora_api_delete_corpus_with_http_info(
        self,
        corpus_name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def corpora_api_delete_corpus_without_preload_content(
        self,
        corpus_name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _corpora_api_delete_corpus_serialize(
        self,
        corpus_name,
        _request_auth,
        _content_type,
