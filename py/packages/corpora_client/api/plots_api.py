...
class PlotsApi:
    ...
    def get_matplotlib_plot(
        ...
        _param = self._get_matplotlib_plot_serialize(
    ...
    @validate_call
    def get_matplotlib_plot_with_http_info(
        self,
        corpus_chat_schema: CorpusChatSchema,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PlotResponseSchema]:
        """Get Matplotlib Plot
    ...
    @validate_call
    def get_matplotlib_plot_without_preload_content(
        self,
        corpus_chat_schema: CorpusChatSchema,
        _request_timeout: Union[
            None,
    ...
    def _get_matplotlib_plot_serialize(
        self,
        corpus_chat_schema,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/corpora/plots/matplotlib',
